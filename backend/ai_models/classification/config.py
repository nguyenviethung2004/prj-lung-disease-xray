...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Huấn luyện mô hình ResNet50 cho Classification trên tập dữ liệu Chest X-ray")
    ...
    parser.add_argument("--model_name", type=str, default="resnet50_classification.pt", help="Tên file mô hình sẽ lưu")
